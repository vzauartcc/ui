	...
	<div class="card">
		<div class="card-content">
			...
			<div v-else>
				<div class="card_desc">
					<p>
						We welcome your request for staffing! Use the form below to send a request for staffing. The time is in <strong>ZULU</strong>. The time will also show you the Central Timezone equivalent after entry to help with selecting the right date and time.
					</p>
				</div>
				<div v-if="!user.isLoggedIn">
					<p>To prevent abuse of the system, all users need to log in via VATSIM before sending feedback. The only details shared with us are your name and email address; your password is never revealed.</p><br />
