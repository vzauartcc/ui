	...
	<div class="card">
        ...
        <tr v-for="(event, i) in events" :key="event.id">
          ...
          <td class="options">
            ...
            <a href="#" data-position="top" data-tooltip="Delete Event" class="tooltipped modal-trigger" @click.prevent="openModal(i, 'delete')">
              <i class="material-icons red-text text-darken-2">delete</i>
            </a>
            <a href="#" data-position="top" data-tooltip="Send Discord Notification" class="tooltipped modal-trigger" @click.prevent="openModal(i, 'send')">
    ...
    <div v-for="(event, i) in events" :key="`modal_${i}`">
      ...
      <div :id="`modal_delete_${i}`" class="modal modal_delete">
        ...
        <div class="modal-footer">
          <a href="#" class="modal-close waves-effect waves-light btn" @click.prevent="deleteEvent(event.url)">Delete</a>
      ...
      <div :id="`modal_send_${i}`" class="modal modal_send">
        <div class="modal-content">
          ...
          <div class="row">
            <div class="col s6">
              <a href="#" class="modal-close waves-effect waves-light btn" @click.prevent="submitForm(event.url)">Submit</a>
            </div>
            <div class="col s6">
              <a href="#" class="modal-close waves-effect waves-light btn-flat" @click.prevent>Cancel</a>
            </div>
