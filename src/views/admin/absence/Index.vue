	...
	<div class="card home_intro">
		<div class="card-content">
			<div class="row row_no_margin">
				...
				<div class="col s4">
					<router-link to="/admin/absence/new"><span class="btn right">New</span></router-link>
				</div>
			</div>
		</div>
		...
		<p class="no_absence" v-else-if="absences && absences.length === 0">
			There are no controllers on Leave of Absence
		</p>
					...
					<tr v-for="(absence, i) in absences" :key="absence._id">
						...
						<td class="options">
							<a
								...
								@click.prevent="openModal(i, 'absence')"
							>
				...
				<div :id="`modal_absence_${i}`" class="modal modal_absence">
					<div class="modal-content">
						<div class="modal_title">
							Leave of Absence for {{ absence.user.fname }} {{ absence.user.lname }}
						</div>
						<div class="absence">
