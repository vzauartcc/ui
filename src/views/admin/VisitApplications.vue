      ...
      <div v-for="app in applications" :key="`modal_${app.cid}`">
        ...
        <div :id="`modal_${app.cid}`" class="modal modal_visit">
          ...
          <div class="modal-footer">
            ...
            <a href="#" class="waves-effect waves-light btn right" @click.prevent="approveVisitor(app.cid)">Approve</a>
          </div>
        </div>
        ...
        <div :id="`modal_reject_${app.cid}`" class="modal modal_visit">
          <div class="modal-content">
            ...
            <p>
              ...
              <strong>{{ app.fname + " " + app.lname }}</strong>. You must provide a reason for rejection below. This will
          ...
          <div class="modal-footer">
            <a href="#" class="waves-effect btn modal-close" @click.prevent="rejectVisitor(app.cid)">Reject</a>
