    ...
    <div class="card-content">
      <div class="row row_no_margin">
        <div class="card-title col s8"><span class="card-title">Solo Certificates</span></div>
          <div class="col s4"><router-link to="/ins/solo/new">
            <span class="btn waves-effect waves-light right">New</span></router-link></div>
          </div>
          <div>
          ...
          <table class="certs_list striped compact">
            ...
            <tbody class="certs_list_row">
              <tr v-for="(cert, i) in certs" :key="cert.id">
                ...
                <td>{{ cert.expires }}</td>
                <td class="options">
                  <a href="#" @click.prevent="openModal(cert.cid)" data-position="top" data-tooltip="Delete Solo Certificate" class="tooltipped">
        ...
        <teleport to="body">
          <div v-for="(cert, i) in certs" :key="`modal_delete_${cert.cid}`">
            <div :id="`modal_delete_${cert.cid}`" class="modal modal_delete">
              ...
              <div class="modal-footer">
                <a href="#" @click.prevent="deleteCert(cert.id, cert.cid, cert.position)" class="btn waves-effect modal-close">Delete</a>
