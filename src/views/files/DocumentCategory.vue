<template>
	<div :id="cat" class="col s12">
		...
		<div class="document" v-else v-for="doc in docs" :key="doc.id">
			...
			<a v-else :href="`https://zauartcc.sfo3.digitaloceanspaces.com/${spaceName}/documents/${doc.fileName}`" target="_blank" class="btn button"><i class="material-icons">search</i></a>
